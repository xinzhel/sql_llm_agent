...
def generate_answers_to_text_queries():
    """ Generate answers to text queries.
    Args:
        None
    
    Returns:
        answers_to_text_queries (Dict[str, List[Dict[str, List]]): Dictionary of dictionaries where the key is the table name and the value is a list of dictionaries.
          each element (dict) in the list contains answers-to-queries for a specific SQL template.
          i.e.,
          { 
                table1: 
                    [
                        {answer1: [fillin1_for_text_template1_for_sql_template1, fillin1_for_text_template2_for_sql_template1, ...}, answer2: []],    
                        {answer1: [fillin1_for_text_template1_for_sql_template2, fillin1_for_text_template2_for_sql_template2, ...], answer2: []},
                    ], 
                ...
        }
